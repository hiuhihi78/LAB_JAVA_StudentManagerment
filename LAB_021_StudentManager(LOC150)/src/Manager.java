...
class Manager {
    ...
    public static void create(ArrayList<Student> list) {
        ...
        while (true) {
            ...
            count = count + 1;
            if (count > 0) { // check added 3 students
    ...
    public static void updateOrDelete(ArrayList<Student> list) {
        ...
        if (choiceUpdateOrDelete.equalsIgnoreCase("u")) {// update
            ...
            if(studentUpdateExisted == true){ // newID was existed
                if(student.getName().equalsIgnoreCase(name) == true){ // input old name
                    
                }else{ // input new name for this id
                    ...
                    if(wantUpdateNewName == true){ // set new name with all record with same id
                        for(Student studentUpdate : list){
                            if(studentUpdate.getId().equalsIgnoreCase(newId)){
